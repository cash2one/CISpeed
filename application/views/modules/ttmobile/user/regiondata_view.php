...
<body>
<form id="form1" method="post" action="/ttmobile/user/regiondata">
<div id="headarea" class="Corner">
	<h1><img src="/res/images/admin/icon/9.gif" alt="" />地区分布 <input type="button" onclick="window.location.href = location;" class="button" value="刷新" /></h1>
...
<script type="text/javascript">
	...
	var str=
	"<graph caption='地区分布图' showNames='1 ' decimalPrecision='0' formatNumberScale='0'>"+
        "	<?php echo $fusionData?>"+
        "</graph>";
