...
<body>
<form id="form1" method="post" action="/ttmobile/user/mobiletypedata">
<div id="headarea" class="Corner">
	<h1><img src="/res/images/admin/icon/9.gif" alt="" />手机型号分布 <input type="button" onclick="window.location.href = location;" class="button" value="刷新" /></h1>
	选择日期：<input name="QueryDate1" id="QueryDate1" type="text" size="20" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'2011-09-08',maxDate:'%y-%M-#{%d-1}'})" class="input" />
	<input type="button" value="查询" class="button" onclick="checkthis();" />
	<div id="chartdiv" align="left" style="margin-top: 5px;">T</div>
</div>
<table class="table" cellspacing="0" cellpadding="0">
	<tr><th>手机型号</th><th>系统</th><th>使用量</th></tr>
	<?php echo $list; ?>
</table>
<?php echo $page; ?>
...
<script type="text/javascript">
	...
	var str=
	"<graph caption='手机型号分布图' showNames='1 ' decimalPrecision='0' formatNumberScale='0'>"+
        "	<?php echo $fusionData?>"+
        "</graph>";
