...
<body>
<form id="form1" method="post" action="/ttmobile/data/devinfodata">
<div id="headarea" class="Corner">
	<h1><img src="/res/images/admin/icon/9.gif" alt="" />激活人数统计 <input type="button" onclick="window.location.href = location;" class="button" value="刷新" /></h1>
	选择设备：<select name="dev" id="dev">
...
<script type="text/javascript">
	...
	var str=
	"<chart palette='3' caption='每5分钟激活人数' showValues='0' divLineDecimalPrecision='1' limitsDecimalPrecision='1' formatNumberScale='0'>"+
