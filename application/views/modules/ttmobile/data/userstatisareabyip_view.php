...
<body>
<form id="form1" method="post" action="/ttmobile/data/userstatisareabyip">
<div id="headarea" class="Corner" style="width:1500px">
	<h1><img src="/res/images/admin/icon/9.gif" alt="" />登录注册按IP分布<input type="button" onclick="window.location.href = location;" class="button" value="刷新" /></h1>
