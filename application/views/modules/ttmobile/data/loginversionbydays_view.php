...
<body>
<form id="form1" method="post" action="/ttmobile/data/loginversionbydays">
<div id="headarea" class="Corner">
<h1><img src="/res/images/admin/icon/9.gif" alt="" />手机通通各版本周期登录数
    ...
    日期：<input name="QueryDate1" id="QueryDate1" type="text" size="20"
	         onFocus="WdatePicker({dateFmt:'yyyy-MM',minDate:'2011-06',maxDate:'%y-%M'})" class="input" />
