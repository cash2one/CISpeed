...
<div id="headarea" class="Corner">
	<h1><img src="/res/images/admin/icon/9.gif" alt="" />队列数据<input type="button" onclick="window.location.href = location;" class="button" value="刷新" /></h1>
...
<table class="table" cellspacing="0" cellpadding="0">
	<tr><th>时间</th><th>队列长度</th><th>接通电话数</th><th>在线坐席数</th><th>接通人数</th></tr>
        <?php echo $list?>
</table>
...
<script type="text/javascript">
	...
	var str=
	"<chart palette='3' caption='每5分钟数据' showValues='0' divLineDecimalPrecision='1' limitsDecimalPrecision='1' formatNumberScale='0'>"+
