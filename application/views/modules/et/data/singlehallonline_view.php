...
<body>
<form id="form1" method="post" action="/et/data/singlehallonline">
<div id="headarea" class="Corner">
<h1><img src="/res/images/admin/icon/9.gif" alt="" />单频道每5分钟语音在线 <input
	type="button" onclick="window.location.href = location;" class="button"
	value="刷新" /></h1>
频道号：<input type="text" name="hallid" id="hallid" class="input" /> 选择日期：<input
