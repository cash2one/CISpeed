...
<body>
<form id="form1" method="post" action="/speed/online">
<div id="headarea" class="Corner">
<h1><img src="/res/images/admin/icon/9.gif" alt="" />用户在线人数统计 <input
...
<script type="text/javascript" src="/res/script/speed.js"></script> <script
	...
	var str=
	"<chart palette='3' caption='每5分钟在线人数' showValues='0' divLineDecimalPrecision='1' limitsDecimalPrecision='1' formatNumberScale='0'>"+
	"<categories><?php
